# M5_Clock Constitution

この文書は、M5_Clock の開発組織における最上位 contract です。
...
M5_Clock の開発組織の目的は current procedure への服従ではありません。
...
M5_Clock is firmware for M5Stack hardware. Source, compiled firmware, selected board profile, flashed device state, Wi-Fi credential state, and observed device behavior are distinct identities.
